    ...
    var Controller = {
        index: function () {
            ...
            if (localStorage.getItem("fastep") == "installed") {
                $.ajax({
                    url: Config.admin.api_url + '/addon/recommend',
                    type: 'post',
                    dataType: 'jsonp',
                    success: function (ret) {
            ...
            var checkupdate = function (ignoreversion, tips) {
                $.ajax({
                    ...
                    type: 'post',
                    data: {version: Config.admin.version},
                    dataType: 'jsonp',
                    success: function (ret) {
            ...
            if (Config.admin.checkupdate && ignoreversion !== "*") {
            ...
            $(document).on('click', "ul.wipecache li a", function () {
                $.ajax({
                    url: Config.moduleurl+'/ajax/wipecache',
                    dataType: 'json',
            ...
            var multiplenav = Config.admin.multiplenav;
            ...
            $(document).on('click', '.lang', function () {
                Fast.api.ajax({
                    url:  Config.moduleurl+'/index/lang',
