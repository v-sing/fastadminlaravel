define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'content/bootpage/index',
                    add_url: 'content/bootpage/add',
                    edit_url: 'content/bootpage/edit',
                    del_url: 'content/bootpage/del',
                    multi_url: 'content/bootpage/multi',
                    table: 'boot_page',
                }
            });
