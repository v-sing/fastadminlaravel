...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-setting-tab">
            ...
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox" data-sidebarskin="toggle" class="pull-right"> {{lang('Toggle Right Sidebar Skin')}}</label><p>{{lang('Toggle between dark and light skins for the right sidebar')}}</p></div>
            <h4 class="control-sidebar-heading">{{lang('Skins')}}</h4>
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            <h4 class="control-sidebar-heading">{{lang('Setting')}}</h4>
        </div>
        <!-- /.tab-pane -->
    </div>
</aside>
